...
mod_tbats_ts_w # settimana AIC = 20255.94
mod_tbats # anno AIC = 20659.81
...
#create data frame with date and KWh for tbats model
...
table_tbats_test <- data_u6_day[num_oss,]
